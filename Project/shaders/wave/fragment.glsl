...
// Color parameters
uniform vec4 uCenterColor;      // Color at the center of the plane
uniform vec4 uEdgeColor;        // Color at the edges of the plane
uniform vec4 uWavePeakColor;    // Color for wave peaks (high points)
uniform vec4 uWaveTroughColor;  // Color for wave troughs (low points)
...
void main()
{
    ...
    // Create smooth radial gradient from center to edge
